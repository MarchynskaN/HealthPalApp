...
import com.example.healthpal.databinding.FragmentBuyMedicineCartBinding;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.HashMap;

public class BuyMedicineCartFragment extends Fragment {
    private FragmentBuyMedicineCartBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBuyMedicineCartBinding.inflate(inflater, container, false);
        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavController navController = NavHostFragment.findNavController(BuyMedicineCartFragment.this);
                navController.navigate(R.id.action_buyMedicineCartFragment_to_buyMedicineCheckout, args);
            }
        });
